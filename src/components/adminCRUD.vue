<template>
  <div class="min-h-screen py-3">
    ...
    <div class="container mx-auto px-4 flex flex-col md:flex-row">
      ...
      <div class="flex-1">
        ...
        <div v-if="hasActiveFilters" class="mb-4 flex flex-wrap gap-2">
          ...
          <span
            v-if="currentFilters.promo"
            class="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded-full"
          >
            Khuyến mãi
            <button
              @click="removeFilter('promo')"
          ...
          <span
            v-if="currentFilters.selectedCategoryId"
          ...
          <button
            ...
            class="bg-red-100 text-red-800 text-xs px-2 py-1 rounded-full hover:bg-red-200"
          >
            Xóa tất cả
          </button>
        </div>
        ...
        >
          ...
          >
            ...
            <!-- Flash Sale Badge -->
            <div
              v-if="book.isFlashSale"
              class="absolute top-2 right-2 bg-red-600 text-white text-xs px-2 py-1 rounded-md font-medium z-10 animate-pulse"
            >
              FLASH SALE
            </div>
            ...
            <div class="h-64 overflow-hidden relative">
              <img
                :src="book.imgURL1 || '/placeholder.svg?height=256&width=192'"
                alt="Book cover"
            ...
            <div class="p-4">
              ...
              <div class="flex justify-center items-center space-x-2">
                <span class="font-medium"
                  >{{
                    formatPrice(
                      calculateDiscountPrice(book.price, book.discount)
                    )
                  }}
                  đ</span
                >
                <span
                  ...
                  class="bg-red-800 text-white text-xs px-2 py-0.5 rounded"
                  >-{{ book.discount }}%</span
                >
              </div>
              <div
                v-if="book.discount > 0"
                class="text-gray-500 text-sm text-center line-through"
              >
          ...
          <nav class="flex items-center space-x-2">
            ...
            <div class="flex items-center space-x-1">
              ...
              <template v-if="visiblePages[0] > 1">
                ...
                <span v-if="visiblePages[0] > 2" class="px-2 text-gray-500"
                  >...</span
                >
              </template>
        ...
        <div
          v-if="totalPages > 1"
          class="mt-4 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-600 space-y-2 sm:space-y-0"
        >
          <div>
            Trang {{ currentPage }} / {{ totalPages }} ({{ totalItems }} sản
            phẩm)
          </div>
          <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-2">
              ...
              <button
                ...
                :disabled="
                  !jumpToPage || jumpToPage < 1 || jumpToPage > totalPages
                "
    ...
    >
      <div
        class="bg-white rounded-lg max-w-6xl w-full my-8 max-h-[90vh] flex flex-col"
      >
        <div class="flex justify-between items-center p-4 border-b bg-white">
          ...
          <button
            @click="showFlashSaleModal = false"
        ...
        <div class="p-4 overflow-y-auto flex-1">
          ...
          <div class="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
            ...
            <form
              @submit.prevent="createFlashSale"
                ...
                <div class="relative">
                  ...
                  >
                    ...
                    >
                      <img
                        :src="
                          book.imgURL1 || '/placeholder.svg?height=32&width=24'
                        "
                        alt=""
                      ...
                      <div class="flex-1 min-w-0">
                        ...
                        <div class="text-xs text-gray-500">
                          ID: {{ book.bookID }} • {{ book.author }}
                        </div>
                      </div>
                    </div>
                    <div
                      v-if="filteredBooksForSelection.length > 8"
                      class="p-2 text-center text-xs text-gray-500 bg-gray-50"
                    >
                  ...
                  <div
                    v-if="selectedBookForFlashSale"
                    class="mt-2 p-2 bg-green-50 border border-green-200 rounded-md"
                  >
                    <div class="flex items-center text-sm">
                      <img
                        :src="
                          selectedBookForFlashSale.imgURL1 ||
                          '/placeholder.svg?height=32&width=24'
                        "
                        alt=""
                      ...
                      <div class="flex-1">
                        <div class="font-medium text-gray-900 truncate">
                          {{ selectedBookForFlashSale.title }}
                        </div>
                        <div class="text-xs text-gray-500">
                          ID: {{ selectedBookForFlashSale.bookID }}
                        </div>
                      </div>
                      <button
                        type="button"
                        @click="clearSelectedBookForFlashSale"
          ...
          <div>
            ...
            >
              <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr
                      v-for="flashSale in filteredFlashSales"
                    ...
                    >
                      <td class="px-4 py-3">
                        <div class="flex items-center">
                          <img
                            :src="
                              flashSale.bookImgURL ||
                              '/placeholder.svg?height=32&width=24'
                            "
                            alt=""
                            class="w-8 h-10 object-cover rounded mr-3"
                          />
                      ...
                      <td class="px-4 py-3">
                        <span
                          :class="[
                            ...
                            getFlashSaleStatus(flashSale) === 'active'
                              ? 'bg-green-100 text-green-800'
                              : getFlashSaleStatus(flashSale) === 'upcoming'
                      ...
                      <td class="px-4 py-3">
                        <div class="flex space-x-2">
                          <button
                            ...
                            :disabled="
                              getFlashSaleStatus(flashSale) === 'expired'
                            "
                          >
                            Sửa
                          </button>
              ...
              <div
                v-if="filteredFlashSales.length === 0"
    ...
    >
      <div
        class="bg-white rounded-lg max-w-5xl w-full my-8 max-h-[90vh] flex flex-col"
      >
        <div class="flex justify-between items-center p-4 border-b bg-white">
        ...
        <div class="p-4 overflow-y-auto flex-1">
          <form @submit.prevent="saveBook">
            ...
            <div class="mb-4">
              ...
              <div class="grid grid-cols-3 gap-3">
                ...
                <div class="space-y-1">
                  ...
                  >
                    ...
                    <div
                      v-if="!imagePreviews.img1"
                      class="text-center h-full flex flex-col justify-center"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        class="h-8 w-8 mx-auto text-gray-400"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
              ...
              <div v-if="uploadError" class="mt-2 text-red-600 text-xs">
                {{ uploadError }}
              </div>
            </div>
    ...
    >
      <div class="bg-white rounded-lg max-w-md w-full p-6 my-8">
        ...
        <p class="mb-6">
          Bạn có chắc chắn muốn xóa sách "{{ bookToDelete?.title }}" không? Hành
              ...
              <div class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span class="font-medium ml-2">{{
                      quickViewBook.supplier || "Không có thông tin"
                    }}</span>
                  </div>
                  <div>
                ...
                <div class="space-y-2">
                  <div class="flex items-center space-x-2">
                    ...
                    >
                    <span
                      v-if="quickViewBook.discount > 0"
                      class="bg-red-500 text-white text-xs px-2 py-1 rounded"
                      >-{{ quickViewBook.discount }}%</span
                    >
                  </div>
                  <div
                    v-if="quickViewBook.discount > 0"
                  ...
                  >
                    {{ formatPrice(quickViewBook.price) }} đ
                  </div>
                </div>
...
const canCreateFlashSale = computed(() => {
  return (
    selectedBookForFlashSale.value &&
    ...
    new Date(newFlashSale.value.startTime) <
      new Date(newFlashSale.value.endTime)
  );
});

const activeFlashSales = computed(() => {
  const now = new Date();
  return allFlashSales.value.filter(
    (fs) => new Date(fs.startTime) <= now && new Date(fs.endTime) >= now
  );
});
  ...
  try {
    ...
    while (hasMorePages && currentPage <= 10) {
      ...
      const response = await axios.get(
        `/admin/products?page=${currentPage}&pageSize=100`
      );
...
const filterBooks = () => {
  ...
  filteredBooksForSelection.value = allBooks.value.filter((book) => {
    ...
    const supplierMatch =
      book.supplier && book.supplier.toLowerCase().includes(query);
...
const updateFlashSale = async () => {
  try {
    ...
    await axios.put(
      `/admin/flash-sale/${editingFlashSale.value.flashSaleID}`,
      updateData
    );
...
// Add this function before uploadImageFile
const deleteFromCloudinary = async (publicId) => {
  try {
    const timestamp = Math.round(new Date().getTime() / 1000);
    const signature = generateSignature(publicId, timestamp); // You'll need to implement this

    await axios.post(
      "https://api.cloudinary.com/v1_1/dljdnrnl6/image/destroy",
      {
        public_id: publicId,
        timestamp: timestamp,
        signature: signature,
...
const uploadImageFile = async (file, imageKey) => {
  try {
    ...
    const cloudinaryUrl =
      "https://api.cloudinary.com/v1_1/dljdnrnl6/image/upload";
    const formData = new FormData();
    formData.append("file", file);
    formData.append("upload_preset", "books_upload"); // Thay bằng upload preset của bạn
    formData.append("folder", "books"); // Tạo folder riêng cho sách
    ...
    // Step 3: Update the book data with Cloudinary URL
    const urlField =
      imageKey === "img1"
        ? "imgURL1"
        : imageKey === "img2"
        ? "imgURL2"
        : "imgURL3";
    editingBook.value[urlField] = cloudinaryImageUrl;
    ...
    if (err.response && err.response.data && err.response.data.error) {
      uploadError.value = `Cloudinary error: ${err.response.data.error.message}`;
    } else {
      uploadError.value = "Không thể tải ảnh lên Cloudinary. Vui lòng thử lại.";
    }
...
const fetchBooks = async () => {
  try {
    ...
    const response = await axios.get(
      `/Book/admin/query?${queryParams.toString()}`
    );
    const data = response.data;
    ...
    const flashSaleBooks = new Set(
      flashSalesResponse.data.map((fs) => fs.bookID)
    );
...
const openQuickView = async (book) => {
  try {
    ...
    quickViewBook.value = {
      ...
      stock:
        detailedBook.stock !== undefined ? detailedBook.stock : book.stock || 0,
...
const saveBook = async () => {
  ...
  try {
    if (
      !editingBook.value.title ||
      !editingBook.value.author ||
      !editingBook.value.price
    ) {
      throw new Error(
        "Vui lòng điền đầy đủ thông tin bắt buộc (Tiêu đề, Tác giả, Giá)"
      );
    }

    // Xử lý publishYear - chuyển năm thành DateTime cho backend
    const publishYear =
      Number(editingBook.value.publishYear) || new Date().getFullYear();

    const bookData = {
      ...(isEditMode.value &&
        editingBook.value.bookID && {
          bookID: Number(editingBook.value.bookID),
        }),
    ...
    if (isEditMode.value && editingBook.value.bookID) {
      response = await axios.put(
        `/admin/products/${editingBook.value.bookID}`,
        bookData
      );
    } else {
